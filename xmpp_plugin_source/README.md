...
- `slixmpp-omemo` installed in the Hermes virtualenv:
  ```bash
  /home/beautifulplace/.hermes/hermes-agent/venv/bin/python -m pip install slixmpp-omemo
  ```
...
platforms:
  xmpp:
    avatar_path: /home/beautifulplace/.hermes/cache/images/xmpp_avatar.png
```
...
- `edge-tts` installed in the Hermes virtualenv:
  ```bash
  /home/beautifulplace/.hermes/hermes-agent/venv/bin/python -m pip install edge-tts
  ```
